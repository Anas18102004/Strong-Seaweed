    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          <div className="space-y-1 lg:space-y-1 overflow-x-auto lg:overflow-visible pb-1">
            <div className="flex lg:block gap-2 min-w-max lg:min-w-0">
              {tabs.map((t) => (
                <button
                  key={t.id}
                  onClick={() => setActiveTab(t.id)}
                  className={`w-auto lg:w-full flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium transition-all whitespace-nowrap ${
                    activeTab === t.id
